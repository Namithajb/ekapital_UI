...
!function(t){t.isScrollToFixed=function(e){return void 0!==t(e).data("ScrollToFixed")},t.ScrollToFixed=function(e,i){function n(){v.trigger("preUnfixed"),c(),v.trigger("unfixed"),b=-1,D=v.offset().top,_=v.offset().left,p.options.offsets&&(_+=v.offset().left-v.position().left),-1==k&&(k=_),g=v.css("position"),y=!0,-1!=p.options.bottom&&(v.trigger("preFixed"),l(),v.trigger("fixed"))}function a(){var t=p.options.limit;return t?"function"==typeof t?t():t:0}function s(){return"fixed"===g}function r(){return"absolute"===g}function o(){return!(s()||r())}function l(){s()||(w.css({display:v.css("display"),width:v.outerWidth(!0),height:v.outerHeight(!0),"float":v.css("float")}),v.css({width:v.width(),position:"fixed",top:-1==p.options.bottom?u():"",bottom:-1==p.options.bottom?"":p.options.bottom}),g="fixed")}function h(){v.css({width:v.width(),position:"absolute",top:a(),left:_}),g="absolute"}function c(){o()||(b=-1,w.css("display","none"),v.css({width:"",position:"",left:"",top:""}),g=null)}function d(t){t!=b&&(v.css("left",_-t),b=t)}function u(){return p.options.marginTop}function f(){if(t.isScrollToFixed(v)){var e=y;y||n();var i=t(window).scrollLeft(),f=t(window).scrollTop(),g=a();p.options.minWidth&&t(window).width()<p.options.minWidth?o()&&e||(m(),v.trigger("preUnfixed"),c(),v.trigger("unfixed")):-1==p.options.bottom?g>0&&f>=g-u()?r()&&e||(m(),v.trigger("preAbsolute"),h(),v.trigger("unfixed")):f>=D-u()?(s()&&e||(m(),v.trigger("preFixed"),l(),b=-1,v.trigger("fixed")),d(i)):o()&&e||(m(),v.trigger("preUnfixed"),c(),v.trigger("unfixed")):g>0?f+t(window).height()-v.outerHeight(!0)>=g-u()?s()&&(m(),v.trigger("preUnfixed"),c(),v.trigger("unfixed")):(s()||(m(),v.trigger("preFixed"),l()),d(i),v.trigger("fixed")):d(i)}}function m(){var t=v.css("position");"absolute"==t?v.trigger("postAbsolute"):"fixed"==t?v.trigger("postFixed"):v.trigger("postUnfixed")}var p=this;p.$el=t(e),p.el=e,p.$el.data("ScrollToFixed",p);var g,y=!1,v=p.$el,D=0,_=0,k=-1,b=-1,w=null,M=function(){v.is(":visible")&&(y=!1,f())},Y=function(){f()};p.init=function(){p.options=t.extend({},t.ScrollToFixed.defaultOptions,i),("iPad"!==navigator.platform&&"iPhone"!==navigator.platform&&"iPod"!==navigator.platform||navigator.userAgent.match(/OS 5_.*\ like Mac OS X/i))&&(p.$el.css("z-index",p.options.zIndex),w=t("<div />"),g=v.css("position"),o()&&p.$el.after(w),t(window).bind("resize.ScrollToFixed",M),t(window).bind("scroll.ScrollToFixed",Y),p.options.preFixed&&v.bind("preFixed.ScrollToFixed",p.options.preFixed),p.options.postFixed&&v.bind("postFixed.ScrollToFixed",p.options.postFixed),p.options.preUnfixed&&v.bind("preUnfixed.ScrollToFixed",p.options.preUnfixed),p.options.postUnfixed&&v.bind("postUnfixed.ScrollToFixed",p.options.postUnfixed),p.options.preAbsolute&&v.bind("preAbsolute.ScrollToFixed",p.options.preAbsolute),p.options.postAbsolute&&v.bind("postAbsolute.ScrollToFixed",p.options.postAbsolute),p.options.fixed&&v.bind("fixed.ScrollToFixed",p.options.fixed),p.options.unfixed&&v.bind("unfixed.ScrollToFixed",p.options.unfixed),p.options.spacerClass&&w.addClass(p.options.spacerClass),v.bind("resize.ScrollToFixed",function(){w.height(v.height())}),v.bind("scroll.ScrollToFixed",function(){v.trigger("preUnfixed"),c(),v.trigger("unfixed"),f()}),v.bind("remove.ScrollToFixed",function(){v.trigger("preUnfixed"),c(),v.trigger("unfixed"),t(window).unbind("resize.ScrollToFixed",M),t(window).unbind("scroll.ScrollToFixed",Y),v.unbind(".ScrollToFixed"),p.$el.removeData("ScrollToFixed")}),M())},p.init()},t.ScrollToFixed.defaultOptions={marginTop:0,limit:0,bottom:-1,zIndex:1e3},t.fn.scrollToFixed=function(e){return this.each(function(){new t.ScrollToFixed(this,e)})}}(jQuery);
...
jQuery(document).ready(function(t){var e=300,i=1200,n=700,a=t(".cd-top");t(window).scroll(function(){t(this).scrollTop()>e?a.addClass("cd-is-visible"):a.removeClass("cd-is-visible cd-fade-out"),t(this).scrollTop()>i&&a.addClass("cd-fade-out")}),a.on("click",function(e){e.preventDefault(),t("body,html").animate({scrollTop:0},n)})});
function resizewindow(){console.log("Window Height: "+jQuery(window).height()),console.log("Window Width: "+jQuery(window).width()),console.log("__________________")}jQuery(document).ready(function(){$("#accordion").accordion();var t=window.location;jQuery('ul a[href="'+t+'"]').parent().addClass("active"),jQuery("ul a").filter(function(){return this.href==t}).parent().addClass("active").parent().parent().addClass("active");var e=window.matchMedia("(min-width: 768px)");e.matches,jQuery("p").each(function(){"&nbsp;"==jQuery(this).html()&&jQuery(this).css("font-size","10px").css("line-height",".4")});var i=jQuery("#testimonials-carousel").owlCarousel({loop:!0,margin:0,nav:!1,responsiveClass:!0,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,autoplaySpeed:5e3,dots:!1,responsive:{0:{items:1,nav:!1,dots:!1},800:{items:1,nav:!1,dots:!1},1e3:{items:1,nav:!1}}});i.owlCarousel(),$("#testimonials-carousel-left").click(function(){i.trigger("next.owl.carousel")}),$("#testimonials-carousel-right").click(function(){i.trigger("prev.owl.carousel",[300])});var n=jQuery("#destination-carousel").owlCarousel({loop:!0,margin:20,nav:!1,responsiveClass:!0,autoplay:!0,autoplayTimeout:1e3,autoplayHoverPause:!0,autoplaySpeed:2e3,dots:!1,responsive:{0:{items:1,nav:!1,dots:!1},800:{items:2,nav:!1,dots:!1},1e3:{items:2,nav:!1}}});n.owlCarousel(),$("#destination-carousel-left").click(function(){n.trigger("next.owl.carousel")}),$("#destination-carousel-right").click(function(){n.trigger("prev.owl.carousel",[300])});var a=jQuery("#brand-carousel").owlCarousel({loop:!0,margin:30,nav:!1,responsiveClass:!0,autoplay:!0,autoplayTimeout:1e3,autoplayHoverPause:!0,autoplaySpeed:2e3,dots:!1,responsive:{0:{items:2,nav:!1},800:{items:3,nav:!1},1e3:{items:4,nav:!1}}});a.owlCarousel(),$("#brand-carousel-left").click(function(){a.trigger("next.owl.carousel")}),$("#brand-carousel-right").click(function(){n.trigger("prev.owl.carousel",[300])});var s=jQuery("#banner-carousel").owlCarousel({loop:!0,margin:30,nav:!1,responsiveClass:!0,autoplay:!0,autoplayTimeout:1e3,autoplayHoverPause:!0,autoplaySpeed:2e3,dots:!1,responsive:{0:{items:1,nav:!1},800:{items:1,nav:!1},1e3:{items:1,nav:!1}}});s.owlCarousel(),$("#banner-carousel-left").click(function(){s.trigger("next.owl.carousel")}),$("#banner-carousel-right").click(function(){s.trigger("prev.owl.carousel",[300])}),$(".rating").raty({score:5,half:!0,starType:"i"}),resizewindow(),$("select.form-control.input-lg").select2()}),jQuery(window).load(function(){jQuery(window).resize(function(){resizewindow()}),resizewindow()});
