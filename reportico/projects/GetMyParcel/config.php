...
define('SW_PROJECT_PASSWORD', '@gmp123');
...
define('SW_PROJECT_TITLE', 'GetMyParcel');
...
define('SW_DB_USER', 'ekapital');
define('SW_DB_PASSWORD', 'fkm-3xj$V');
define('SW_DB_HOST', 'dc2-mysql-05.kattare.com');
define('SW_DB_DATABASE', 'ekapital');
}
