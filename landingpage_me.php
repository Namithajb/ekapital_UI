...
<html lang="en">
  <head>
    ...
    <script src="/plugins/html5shiv/html5shiv-printshiv.min.js"></script>
	...
	<!-- <link rel="stylesheet" type="text/css" href="/resources/css/datatable.min.css"/>
	<link rel="stylesheet" type="text/css" media="screen" href="/resources/css/gmp.css" />
	<script type="text/javascript" src="/resources/js/jquery/datatable.min.js"></script>
	
	dropzone file upload library
	<script src="/resources/plugins/dropzone/dropzone.js" type="text/javascript"></script>-->
	
	<!-- <link rel="stylesheet" type="text/css" href="/resources/css/bootstrap-datepicker.css"/>
	<script src="/resources/js/jquery/bootstrap-datepicker.js" type="text/javascript"></script>  -->
	
	<!-- <link rel="stylesheet" type="text/css" media="screen" href="/resources/css/themes/redmond/jquery-ui-1.8.2.custom.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="/resources/css/themes/ui.jqgrid.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="/resources/css/themes/ui.multiselect.css" /> -->
	          ...
	          <div class="container-fluid">
	            <div class="navbar-header">
	              ...
	              <a class="navbar-brand" href="/xhome.gmp">
	                ...
	                <!-- <img src="/resources/img/favicon.png" alt="" class="img-responsive visible-xs"/> -->
	              </a>
	            </div>
	        </nav>
     		</div>
    ...
    <div class="container ">
	   <div class="row">
	    <section class="col-sm-12 printable">
			...
			<br/><br/>
			<div class="col-sm-8" >
				<h2>Send Couriers / Parcel to India at Great Prices</h2>
				<p>
				<h3>
					<ul>
						...
						<li> Delivery within 2 to 3 days to main cities in India.
						<li> Delivery from &pound;15 available.
			...
			<div class="col-sm-8">
				<h2>Our Service to India</h2>
				<p></p>
<p>
					India is one of the fastest growing economies in the world. With our strategic alliance coupled with the extensive knowledge in the courier industry, GetMyParcel can provide excellent service at economical rates in delivering parcel to India.
</p><p>
We understand the importance and urgency of documents, such as visa application, bank statements and are quite experienced in delivering them. For the past several years we have been handling the courier shipments many Indian expats from the UK to India and other countries. GetMyParcel are sure if given an opportunity, we will be able to provide you with our excellent service.
</p><p>
...
We will offer a tailor made service for your parcel detail. Since non-document parcel to India requires customs paper and KYC documents, we can help with information regarding customs paper works required.

 </p><p>

We regularly update with Customs procedure and latest regulation in India. However  it is the receiver's responsibility to deal with customs duties when delivering goods there. With our office in India we can help the receiver with customs update and other information regarding the customs clearance.
...
Please the link below for parcel restrictions to India.
